...
```
git clone https://github.com/prasanjit6485/Introduction-to-Computer-Vision
...
2. Create (and activate) a new environment, named `cv-nd` with Python 3.6. If prompted to proceed with the install `(Proceed [y]/n)` type y.
	...
	At this point your command line should look something like: `(cv-nd) <User>:cd0360-Introduction-to-Computer-Vision <user>$`. The `(cv-nd)` indicates that your environment has been activated, and you can proceed with further package installations.
